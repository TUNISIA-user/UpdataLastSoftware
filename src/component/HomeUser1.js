...
{/* <   Folder push */}
        ...
        <img src='images/micrsoftStore.png' className='web-app-app' alt='Microsoft Store' />
         ...
         <a href='https://stackoverflow.com/users/20725805/sfir-jahnm' >   <img src='https://static-00.iconduck.com/assets.00/stack-overflow-icon-2048x2048-7ohycn5z.png' className='web-app-app'  />  </a>
        <a href='https://vscode.dev/'>   <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/512px-Visual_Studio_Code_1.35_icon.svg.png?20210804221519'  className='web-app-app' /> </a>
          ...
          <a href='https://github.com/should-be-happy'>    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/GitHub_Invertocat_Logo.svg/1200px-GitHub_Invertocat_Logo.svg.png' className='web-app-app' style={{borderRadius:"10px"}}  /></a>
